    ...
    >
      <div className="relative order-2 xl:order-1 w-full xl:w-[50%] h-[80vh] xmd:h-[100vh] xl:h-[880px] overflow-hidden flex bg-black">
        <div
          ...
          className="absolute left-[-40%] xmd:left-[-10%] xl:left-[-30%] top-[50%] translate-y-[-50%] w-[394px] md:w-[511px] h-[249.25px] md:h-[322.38px] border-[4px] border-white overflow-hidden"
        >
          <Image
        ...
        <div
          ref={(e) => imgsContRef.current.push(e)}
          className="absolute right-[-40%] xmd:right-[-15%] xl:right-[-30%] top-[50%] translate-y-[-50%] w-[394px] md:w-[511px] h-[394px]  md:h-[511px] rounded-full border-[4px] border-white overflow-hidden"
        >
          <Image
      ...
      <div className="order-1 xl:order-2 w-full xl:w-[50%] h-[90vh] xl:h-[880px] py-[48px] px-[72px] flex flex-col justify-between">
